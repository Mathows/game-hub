...
namespace GameHub.Infrastructure.Migrations
{
    ...
    [Migration("20260810133900_AddRegistroAnonimizacao")]
    partial class AddRegistroAnonimizacao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.Cobranca", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.HistoricoStatusNota", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("HistoricosStatusNota");
                });
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.NotaFiscal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PedidoId")
                        .IsUnique()
                        .HasDatabaseName("UX_NotaFiscal_Pedido");

                    b.HasIndex("Serie", "Numero")
                        .IsUnique()
                        .HasDatabaseName("UX_NotaFiscal_Serie_Numero");
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.RegistroAnonimizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("NotasMantidas")
                        .HasColumnType("int");

                    b.Property<int>("PedidosMantidos")
                        .HasColumnType("int");

                    b.Property<string>("ResumoAcoes")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.Cobranca", b =>
                {
                    b.HasOne("GameHub.Domain.Entities.Pedido", "Pedido")
                        .WithOne("Cobranca")
                        .HasForeignKey("GameHub.Domain.Entities.Cobranca", "PedidoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("GameHub.Domain.Entities.HistoricoStatusNota", b =>
                {
                    b.HasOne("GameHub.Domain.Entities.NotaFiscal", "NotaFiscal")
                        .WithMany("Historico")
