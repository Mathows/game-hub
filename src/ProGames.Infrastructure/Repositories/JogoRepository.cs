...
namespace ProGames.Infrastructure.Repositories;

/// <summary>
/// Implementação do repositório de jogos usando o Entity Framework Core.
/// Recebe o ProGamesDbContext por Injeção de Dependência (no construtor).
/// </summary>
public class JogoRepository : IJogoRepository
{
    private readonly ProGamesDbContext _context;

    // O contexto chega PRONTO aqui — não damos "new". Quem monta é o container de DI.
    public JogoRepository(ProGamesDbContext context)
    {
        _context = context;
    }
